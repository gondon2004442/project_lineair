...
export const ITEMS: Item[] = [
  ...
  },
  {
    ...
    report: [
      ...
      'расход обоймы соответственно выше.',
  ...
  },
  {
    ...
    report: [
      ...
      'ЗАКЛЮЧЕНИЕ: перезарядка всех форм заметно короче,',
      'но обойма меньше.',
      'Полную редакцию не искать.',
    ],
    mods: [
      { path: 'weapon.precise.reloadTime', mul: 0.6 },
      { path: 'weapon.scatter.reloadTime', mul: 0.6 },
      { path: 'weapon.lance.reloadTime', mul: 0.6 },
      { path: 'weapon.volley.reloadTime', mul: 0.6 },
  ...
  },
  {
    ...
    report: [
      ...
      'ЗАКЛЮЧЕНИЕ: в обойму всех форм помещается больше,',
      'урон при этом несколько ниже.',
      'Вопрос о полномочиях оставлен открытым.',
    ],
    mods: [
      { path: 'weapon.precise.ammoMax', add: 5 },
      { path: 'weapon.scatter.ammoMax', add: 5 },
      { path: 'weapon.lance.ammoMax', add: 5 },
      { path: 'weapon.volley.ammoMax', add: 5 },
