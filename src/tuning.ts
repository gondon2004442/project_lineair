...
export const TUNING = {
  ...
  render: {
    ...
    floorGrid: 1,
    /** Ореховая панель на стене, обращённой в комнату. */
    wainscotBand: 7,
    /** Латунный профиль над панелью. */
    brassRail: 2,
    ...
    armReach: 1.35,
    armThickness: 0.33,
    /** Ревизор: смещение массы влево и доля головы. */
    bulkShift: 0.25,
    bulkHead: 0.3,
    /** Курьер: насколько он уже квадрата. */
    slimWidth: 0.6,
    /** Стажёр: насколько силуэт приземистый. */
    sunkenSquat: 0.85,
