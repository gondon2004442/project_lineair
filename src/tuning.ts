...
export const TUNING = {
  ...
  render: {
    ...
    dashTrailStep: 0.008,
    /**
     * Шаг субъекта: четыре кадра на цикл, цикл — на walkStride пути.
     * Считаем по пройденному, а не по времени: иначе на замедлении и
     * на разгоне ноги «едут» отдельно от пола.
     */
    walkFrames: 4,
    walkStride: 34,
