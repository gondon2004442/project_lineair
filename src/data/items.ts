...
export const ITEMS: Item[] = [
  ...
  },
  {
    ...
    report: [
      'ОСНОВАНИЕ: пачка копировальной бумаги из архива приёмной.',
      'ОПИСАНИЕ: копия получается раньше оригинала и в двух экземплярах.',
      'Какой из них считать первым, инструкцией не определено.',
      'ЗАКЛЮЧЕНИЕ: в залпе больше снарядов, каждый слабее.',
      'Оригинал не изымать.',
    ],
    mods: [
      { path: 'weapon.volley.count', add: 2 },
      { path: 'weapon.volley.damage', mul: 0.8 },
    ],
  },
  {
    id: 'seal',
    ...
    report: [
      'ОСНОВАНИЕ: сейф кадрового отдела, отпечаток на внутренней стенке.',
      'ОПИСАНИЕ: оттиск ложится ровно и точно в назначенное место',
      'независимо от того, куда направлена рука.',
      'ЗАКЛЮЧЕНИЕ: сноп дробовой формы плотнее и летит быстрее.',
